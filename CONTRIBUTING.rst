...
Welcome to ``Handwritten-digits`` contributor's guide.
...
If you experience bugs or general issues with ``Handwritten-digits``, please have a look
...
You can help improve ``Handwritten-digits`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Handwritten-digits`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Handwritten-digits``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Handwritten-digits python=3 six virtualenv pytest pytest-cov
    conda activate Handwritten-digits
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Handwritten-digits.git
...
#. Install |pre-commit|_::
   ...
   ``Handwritten-digits`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Handwritten-digits
.. _issue tracker: https://github.com/<USERNAME>/Handwritten-digits/issues
.. <-- end -->
